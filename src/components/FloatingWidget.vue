...
export default {
  data() {
    return {
      ...
      booksByMBTI: {
        INFP: { title: "Book 1", image: require('@/assets/book1.jpg') }, // 로컬 이미지 사용 예시
        INFJ: { title: "Book 4", image: require('@/assets/book4.jpg') },
        ISFP: { title: "Book 7", image: require('@/assets/book7.jpg') },
        ISFJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ISTP: { title: "Book 13", image: require('@/assets/book10.jpg') },
        INTP: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ISTJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
        INTJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ENFP: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ESFP: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ENFJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ESFJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ENTP: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ENTJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ESTP: { title: "Book 10", image: require('@/assets/book10.jpg') },
        ESTJ: { title: "Book 10", image: require('@/assets/book10.jpg') },
