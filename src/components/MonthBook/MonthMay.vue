    ...
    <div id="app">
      ...
      <main>
        ...
        <div class="book-section">
          <img src="@/assets/book5month.jpg" alt="Book Cover" class="book-image" />
          <div class="book-info">
            <h2>
              달러구트 꿈 백화점
              <span class="author-name">이미예</span>
            </h2>
            <p>#소설 #장편소설</p>
            <div class="gray-box">
                ...
                온갖 꿈을 한데 모아 판매하는 ‘달러구트의 꿈 백화점’이다. 긴 잠을 자는 사람들은 물론이고, 
                짧은 낮잠을 자는 사람들과 동물들로 매일매일 대성황을 이룬다.
